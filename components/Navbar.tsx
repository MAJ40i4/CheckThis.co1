...
import { Globe, ShieldCheck, BookOpen, ShoppingBasket } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8 text-xs font-bold uppercase tracking-widest text-slate-500">
            ...
            {/* Blog moved here as a main link */}
            <button 
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="hidden sm:block text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-slate-900 transition-colors px-3 py-1.5">{t.signIn}</button>
          </div>
        </div>
      </div>
    </nav>
